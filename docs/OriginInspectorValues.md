...
------------ | ------------- | ------------- | -------------
**responses** | Option<**i64**> | Number of responses from origin. | 
**resp_header_bytes** | Option<**i64**> | Number of header bytes from origin. | 
**resp_body_bytes** | Option<**i64**> | Number of body bytes from origin. | 
**status_1xx** | Option<**i64**> | Number of 1xx \"Informational\" status codes delivered from origin. | 
**status_2xx** | Option<**i64**> | Number of 2xx \"Success\" status codes delivered from origin. | 
**status_3xx** | Option<**i64**> | Number of 3xx \"Redirection\" codes delivered from origin. | 
**status_4xx** | Option<**i64**> | Number of 4xx \"Client Error\" codes delivered from origin. | 
**status_5xx** | Option<**i64**> | Number of 5xx \"Server Error\" codes delivered from origin. | 
**status_200** | Option<**i64**> | Number of responses received with status code 200 (Success) from origin. | 
**status_204** | Option<**i64**> | Number of responses received with status code 204 (No Content) from origin. | 
**status_206** | Option<**i64**> | Number of responses received with status code 206 (Partial Content) from origin. | 
**status_301** | Option<**i64**> | Number of responses received with status code 301 (Moved Permanently) from origin. | 
**status_302** | Option<**i64**> | Number of responses received with status code 302 (Found) from origin. | 
**status_304** | Option<**i64**> | Number of responses received with status code 304 (Not Modified) from origin. | 
**status_400** | Option<**i64**> | Number of responses received with status code 400 (Bad Request) from origin. | 
**status_401** | Option<**i64**> | Number of responses received with status code 401 (Unauthorized) from origin. | 
**status_403** | Option<**i64**> | Number of responses received with status code 403 (Forbidden) from origin. | 
**status_404** | Option<**i64**> | Number of responses received with status code 404 (Not Found) from origin. | 
**status_416** | Option<**i64**> | Number of responses received with status code 416 (Range Not Satisfiable) from origin. | 
**status_429** | Option<**i64**> | Number of responses received with status code 429 (Too Many Requests) from origin. | 
**status_500** | Option<**i64**> | Number of responses received with status code 500 (Internal Server Error) from origin. | 
**status_501** | Option<**i64**> | Number of responses received with status code 501 (Not Implemented) from origin. | 
**status_502** | Option<**i64**> | Number of responses received with status code 502 (Bad Gateway) from origin. | 
**status_503** | Option<**i64**> | Number of responses received with status code 503 (Service Unavailable) from origin. | 
**status_504** | Option<**i64**> | Number of responses received with status code 504 (Gateway Timeout) from origin. | 
**status_505** | Option<**i64**> | Number of responses received with status code 505 (HTTP Version Not Supported) from origin. | 
**status_530** | Option<**i64**> | Number of responses received from origin with status code 530. | 
**latency_0_to_1ms** | Option<**i64**> | Number of responses from origin with latency between 0 and 1 millisecond. | 
**latency_1_to_5ms** | Option<**i64**> | Number of responses from origin with latency between 1 and 5 milliseconds. | 
**latency_5_to_10ms** | Option<**i64**> | Number of responses from origin with latency between 5 and 10 milliseconds. | 
**latency_10_to_50ms** | Option<**i64**> | Number of responses from origin with latency between 10 and 50 milliseconds. | 
**latency_50_to_100ms** | Option<**i64**> | Number of responses from origin with latency between 50 and 100 milliseconds. | 
**latency_100_to_250ms** | Option<**i64**> | Number of responses from origin with latency between 100 and 250 milliseconds. | 
...
**waf_status_505** | Option<**i64**> | Number of responses received with status code 505 (HTTP Version Not Supported) received for origin requests made by the Fastly WAF. | 
...
**compute_status_416** | Option<**i64**> | Number of responses received with status code 416 (Range Not Satisfiable) for origin received by the Compute platform. | 
...
**all_status_301** | Option<**i64**> | Number of responses received with status code 301 (Moved Permanently) received for origin requests made by all sources. | 
