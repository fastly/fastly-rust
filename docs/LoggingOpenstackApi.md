...
create_log_openstack(cfg, params)
```
...
[**crate::models::LoggingOpenstackResponse**](LoggingOpenstackResponse.md)
...
delete_log_openstack(cfg, params)
```
...
[**Vec&lt;crate::models::LoggingOpenstackResponse&gt;**](LoggingOpenstackResponse.md)
...
update_log_openstack(cfg, params)
```
