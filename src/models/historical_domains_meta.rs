...
pub struct HistoricalDomainsMeta {
    ...
    pub filters: Option<Box<crate::models::HistoricalDomainsMetaFilters>>,
}

impl HistoricalDomainsMeta {
    /// Meta information about the scope of the query in a human readable format.
    pub fn new() -> HistoricalDomainsMeta {
