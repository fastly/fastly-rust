...
pub struct DdosProtectionResponseConfigure {
    ...
    pub _links: Option<Box<crate::models::DdosProtectionResponseLinksLinks>>,
}

impl DdosProtectionResponseConfigure {
    pub fn new() -> DdosProtectionResponseConfigure {
