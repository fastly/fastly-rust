...
pub struct WafFirewallVersionResponseDataAttributesAllOf {
...
impl WafFirewallVersionResponseDataAttributesAllOf {
    pub fn new() -> WafFirewallVersionResponseDataAttributesAllOf {
