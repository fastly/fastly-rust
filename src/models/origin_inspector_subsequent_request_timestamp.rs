...
pub struct OriginInspectorSubsequentRequestTimestamp {
}

impl OriginInspectorSubsequentRequestTimestamp {
    /// Value to use for subsequent requests.
    pub fn new() -> OriginInspectorSubsequentRequestTimestamp {
