...
pub struct DdosProtectionResponseBodyGetAllServices {
    ...
    pub _links: Option<Box<crate::models::DdosProtectionResponseLinksGetAllServicesLinks>>,
}

impl DdosProtectionResponseBodyGetAllServices {
    pub fn new() -> DdosProtectionResponseBodyGetAllServices {
