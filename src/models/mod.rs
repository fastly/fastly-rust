...
pub mod get_stores_response;
pub use self::get_stores_response::GetStoresResponse;
pub mod get_stores_response_meta;
pub use self::get_stores_response_meta::GetStoresResponseMeta;
pub mod gzip;
