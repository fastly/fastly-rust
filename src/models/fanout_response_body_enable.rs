...
pub struct FanoutResponseBodyEnable {
    ...
    pub _links: Option<Box<crate::models::FanoutResponseLinksLinks>>,
}

impl FanoutResponseBodyEnable {
    pub fn new() -> FanoutResponseBodyEnable {
