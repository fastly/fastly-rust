...
pub struct MutualAuthenticationDataAttributes {
    /// One or more certificates. Enter each individual certificate blob on a new line. Must be PEM-formatted. Required.
    ...
    /// A custom name for your mutual authentication. Required.
