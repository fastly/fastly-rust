...
pub async fn kv_store_list_item_keys(configuration: &mut configuration::Configuration, params: KvStoreListItemKeysParams) -> Result<crate::models::InlineResponse2008, Error<KvStoreListItemKeysError>> {
    let local_var_configuration = configuration;
