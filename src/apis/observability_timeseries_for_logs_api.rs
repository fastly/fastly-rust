...
/// struct for passing parameters to the method [`log_timeseries_get`]
#[derive(Clone, Debug, Default)]
pub struct LogTimeseriesGetParams {
    pub source: String,
...
/// struct for typed errors of method [`log_timeseries_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum LogTimeseriesGetError {
    UnknownValue(serde_json::Value),
}


/// Retrieves log data as time series.
pub async fn log_timeseries_get(configuration: &mut configuration::Configuration, params: LogTimeseriesGetParams) -> Result<crate::models::LogTimeseriesGetResponse, Error<LogTimeseriesGetError>> {
    ...
    let local_var_uri_str = format!("{}/observability/timeseries", local_var_configuration.base_path);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<LogTimeseriesGetError> = serde_json::from_str(&local_var_content).ok();
