...
pub async fn kv_store_create(configuration: &mut configuration::Configuration, params: KvStoreCreateParams) -> Result<crate::models::KvStoreDetails, Error<KvStoreCreateError>> {
    ...
    let local_var_uri_str = format!("{}/resources/stores/kv", local_var_configuration.base_path);
...
/// List all KV stores.
pub async fn kv_store_list(configuration: &mut configuration::Configuration, params: KvStoreListParams) -> Result<crate::models::InlineResponse20010, Error<KvStoreListError>> {
    let local_var_configuration = configuration;
