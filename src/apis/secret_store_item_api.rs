...
pub async fn get_secrets(configuration: &mut configuration::Configuration, params: GetSecretsParams) -> Result<crate::models::InlineResponse20013, Error<GetSecretsError>> {
    let local_var_configuration = configuration;
