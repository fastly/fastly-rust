...
pub async fn delete_service_authorization2(configuration: &mut configuration::Configuration, params: DeleteServiceAuthorization2Params) -> Result<crate::models::InlineResponse20011, Error<DeleteServiceAuthorization2Error>> {
    let local_var_configuration = configuration;
